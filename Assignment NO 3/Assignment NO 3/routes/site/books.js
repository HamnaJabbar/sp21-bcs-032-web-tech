...
router.get("/books/:page?",sessionAuth, async (req, res) => {
...
// const express = require("express");
// let router = express.Router();
// let productSchema = require("../../models/book");

// //route to deliver an edit form
// router.get("/books/edit/:id", async (req, res) => {
//   let book = await productSchema.findById(req.params.id);
//   res.render("admin/books/edit", { layout: "adminlayout",productSchema });
// });
// router.post("/books/edit/:id", async (req, res) => {
...
//     return res.redirect("back");
//   }
//   let productSchema = await productSchema.findByIdAndUpdate(req.params.id, req.body);
//   res.redirect("/admin/books");
// });

// //route to delete a book
// router.get("/books/delete/:id", async (req, res) => {
//   let productSchema = await productSchema.findByIdAndDelete(req.params.id);
//   req.session.flash = { type: "danger", message: "Book Deleted!" };
//   res.redirect("/admin/books");
// });
...
//     return res.redirect("back");
//   }
//   let productSchema = new productSchema(req.body);
...
//   page = Number(page);
//   let pageSize = 3;
//   let productSchema = await productSchema.find()
//     .limit(pageSize)
//     .skip((page - 1) * pageSize);
//   let bookCount = await Book.countDocuments();
//   let totalPages = Math.ceil(bookCount / pageSize);
